  ...
  <ul class="navbar-nav ml-auto">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        @if(auth()->user()->foto_toko)
            <img class="img-profile rounded-circle" src="{{ asset('storage/' . auth()->user()->foto_toko) }}" alt="Foto Toko">
        @else
            <img class="img-profile rounded-circle" src="/admin_assets/img/undraw_profile.svg" alt="Foto Default">
        @endif
    </a>
